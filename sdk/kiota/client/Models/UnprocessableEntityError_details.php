...
class UnprocessableEntityError_details implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new UnprocessableEntityError_details and sets the default values.
    */
     ...
     * @return UnprocessableEntityError_details
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): UnprocessableEntityError_details {
        return new UnprocessableEntityError_details();
    }
