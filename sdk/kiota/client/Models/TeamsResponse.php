...
class TeamsResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<MarvelTeamModel>|null $characters List of Marvel teams.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): TeamsResponse {
    ...
    */
    ...
    /**
     * Gets the characters property value. List of Marvel teams.
     * @return array<MarvelTeamModel>|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'characters' => fn(ParseNode $n) => $o->setCharacters($n->getCollectionOfObjectValues([MarvelTeamModel::class, 'createFromDiscriminatorValue'])),
    ...
    */
    ...
    /**
     * Sets the characters property value. List of Marvel teams.
     * @param array<MarvelTeamModel>|null $value Value to set for the characters property.
    */
