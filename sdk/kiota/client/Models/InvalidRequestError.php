...
class InvalidRequestError extends ApiException implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<InvalidRequestError_details>|null $details An array of objects providing details about the validation errors encountered in the request.
    */
    ...
    */
    ...
    /**
     * Instantiates a new InvalidRequestError and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): InvalidRequestError {
    ...
    */
     ...
     * @return array<InvalidRequestError_details>|null
    */
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'details' => fn(ParseNode $n) => $o->setDetails($n->getCollectionOfObjectValues([InvalidRequestError_details::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @param array<InvalidRequestError_details>|null $value Value to set for the details property.
    */
